Uprav prosím kód tak, aby texty „Podmínky použití“ a „Zásady ochrany soukromí“ na obrazovkách GuideScreen a PlusScreen používaly překlady podle aktuálního jazyka aplikace pomocí knihovny react-i18next.

Chci, aby:

– Texty byly přeloženy přes `t('termsOfUse')` a `t('privacyPolicy')` nebo jiný odpovídající klíč.
– Při kliknutí se dál otevřou příslušné URL, ale samotný **zobrazený text** musí být lokalizovaný.
– Nechci žádné zjednodušení nebo abstraktní návrhy – napiš mi **přesně co mám smazat a co mám vložit**, vždy **celý řádek nebo celý blok**.

Níže posílám obsah souborů `App.tsx` a `GuideScreen.js`. Vrať jen konkrétní úpravy – nepřepisuj celý soubor.
...
import { PlusContext } from './src/context/PlusContext';
        ...
        {!plusCtx.plus ? (
          <>
            ...
            <TouchableOpacity onPress={() => Linking.openURL('https://akrijc.github.io/smartsolarmeter-privacy/terms-of-use.html')}>
              <Text style={{ color: 'blue', textAlign: 'center', marginBottom: 2 }}>
                Podmínky použití
              </Text>
            </TouchableOpacity>
...
import { PlusContext } from '../context/PlusContext'; // ujisti se, že import odpovídá cestě
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', padding: 20 }}>
      <ScrollView>
        ...
        {/* 🔧 Testovací přepínače Plus verze */}
        <View style={{ marginTop: 30 }}>
          <TouchableOpacity
            ...
            onPress={() => plusCtx.setPlus(true)}
          >
            <Text style={{ color: '#fff', fontSize: 16 }}>
              Aktivovat Plus verzi
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            onPress={() => plusCtx.setPlus(false)}
          >
            <Text style={{ color: '#fff', fontSize: 16 }}>
              Deaktivovat Plus verzi
            </Text>
          </TouchableOpacity>
        </View>
